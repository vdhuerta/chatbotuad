...
const ChatWidget: React.FC<ChatWidgetProps> = ({ onClose, onAdminOpen }) => {
  ...
  return (
    <div className="fixed bottom-5 right-5 w-[400px] h-[600px] bg-white rounded-2xl shadow-xl border border-gray-200 flex flex-col z-50 transition-all duration-300 origin-bottom-right animate-[scale-up_0.3s_ease-out] pointer-events-auto">
      {/* Header */}
